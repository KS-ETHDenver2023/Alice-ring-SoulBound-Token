...
// 	function CreateProof( uint256 secret, uint256 message ) pure internal returns (uint256[2] out_pubkey, uint256 out_s, uint256 out_e){
...
// 	function CalcProof( uint256[2] pubkey, uint256 message, uint256 s, uint256 e ) pure internal returns (uint256){
...
// 	function VerifyProof( uint256[2] pubkey, uint256 message, uint256 s, uint256 e ) pure internal returns (bool){
